...
?>
  ...
  <div class="bang" style="width: 895px; margin-bottom: 15px">
      ...
      <?php 
          ...
          $loaidetai = get_one_loaidetai($id); 
      ?>
      <form action="." method="post">
        <input type="hidden" name="action" value="update_loaidetai">
      <div class="bang_hang" style="background-color: #f5f5f5">
        <input type="textbox" name="id" value="<?php echo $loaidetai['loaidetai']?>" class="tx_noneborder" style="width: 45%;" readonly>
        <input type="textbox" name="ghichu" value="<?php echo $loaidetai['ghichu']?>" class="tx_noneborder" style="text-overflow: ellipsis;white-space: nowrap;overflow: hidden;width:53%">
      </div>
      ...
      <div style="overflow: auto; margin-top:10px">
        ...
        <form action="." method="post"> 
          ...
          <input type="hidden" name="id" value="<?php echo $loaidetai['loaidetai']; ?>">

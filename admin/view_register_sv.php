...
<main>
    ...
    <form action="." method="post" id="register_form">
        ...
        <input type="text" name="taikhoan" value="<?php echo $taikhoan; ?>" size="30">
        ...
        <input type="text" name="hovaten" value="<?php echo $hovaten; ?>" size="30">

        <label>Ngay sinh:</label>
        <input type="date" name="ngaysinh" value="<?php echo $ngaysinh; ?>" size="30">
        ...
        <label>Lop:</label>
        <input type="text" name="lop" value="<?php echo $lop; ?>" size="10">
        ...
        <input type="number" name="tinchitichluy" value="<?php echo $tinchitichluy; ?>">
